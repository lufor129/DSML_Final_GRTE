            ...
            if self.is_train:
                ...
                if spoes:
                    ...
                    if len(batch_token_ids) == self.batch_size or is_end:
                        batch_token_ids, batch_mask=[sequence_padding(i,length=self.length) for i in [batch_token_ids, batch_mask]]
                        batch_label=mat_padding(batch_label,length=self.length)
                        batch_mask_label=mat_padding(batch_mask_label,length=self.length)
                        yield [
                            batch_token_ids, 
                            batch_mask,
                            batch_label,
